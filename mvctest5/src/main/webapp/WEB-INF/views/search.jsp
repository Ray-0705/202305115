...
<body>
    <header>
        ...
        <div class="user">
            <a href="<c:url value='myFavorite'/>" id="mf" target="_blank">
    ...
    <main>
        ...
        <div id="result">
            <div class="range">搜尋結果 ：&nbsp;&nbsp;${sum} 筆</div>
                <div id="hl">
                    <a href="<c:url value='/search?keyword=${param.keyword}&order=asc'/>">
                    
                        <div  class="highlow">價格由低到高</div>
                    </a>
                    <a href="?keyword=${param.keyword}&order=desc">
            ...
            <div class="boxstyle">
                ...
                <li type="none" class="searchbox">
                    ...
                    <div class="cp">
                        ...
                        <a href="<c:url value='/addMyFav?name=${item.name}&url=${item.url}
                        &price=${item.price}&img=${item.img}&sourceimg=${item.sourceimg}&keyword=${param.keyword}'/>" class="addlove">
